...
Route::post('/update_artwork/{$id}', [UserController::class, 'update'])->middleware('auth')->name('update_artwork');
Route::post('/delete_artwork/{$id}', [UserController::class, 'destroy'])->middleware('auth')->name('delete_artwork');
